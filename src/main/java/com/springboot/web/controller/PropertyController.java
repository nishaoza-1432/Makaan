...
public class PropertyController {
	...
	public String getAllproperty(@RequestParam(value = "property_type", required = false) String property_type,
			@RequestParam(value = "property_location", required = false) String property_location,Model model, HttpSession session)
	{String name = (String) session.getAttribute("name");
	    Owner owner = orepo.findByName(name);
		...
		System.out.println("Property Location: " + property_location);
...
//        return "redirect:/login";
	...
	@GetMapping("/profileO")
	public String getAllpropert(@RequestParam(value = "property_type", required = false) String property_type,
...
//        return "redirect:/login";
    ...
    public String showSinglePropertyView(@RequestParam("property_id") int property_id, Model model) {
		...
		List<Review> reviews = rservice.getReviewsForProperty(property);
		 Owner propOwner = property.getOwner();
        model.addAttribute("review",new Review());
        model.addAttribute("property", property);
        model.addAttribute("reviews", reviews); 
        model.addAttribute("prop", propOwner); 
